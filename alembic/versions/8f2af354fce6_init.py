...
def upgrade() -> None:
    ...
    user_exercise_table = op.create_table('user_exercise',
    ...
    emg_activation_table = op.create_table('emg_activation',
    sa.Column('id', sa.INTEGER(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['muscle'], ['muscle.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    muscle_table = op.create_table('muscle',
    sa.Column('id', sa.INTEGER(), nullable=False),
    ...
    workout_table = op.create_table('workout',
    sa.Column('id', sa.INTEGER(), nullable=False),
    ...
    user_set_table = op.create_table('user_set',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('user_exercise_id', sa.INTEGER(), nullable=True),
    sa.Column('set_number', sa.INTEGER(), nullable=False),
    sa.Column('weight', sa.INTEGER(), nullable=False),
    sa.Column('reps', sa.INTEGER(), nullable=False),
    sa.ForeignKeyConstraint(['user_exercise_id'], ['user_exercise.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    exercise_table = op.create_table('exercise',
    sa.Column('id', sa.INTEGER(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['muscle_primary'], ['muscle.id'], ),
    sa.ForeignKeyConstraint(['muscle_secondary'], ['muscle.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    program_table = op.create_table('program',
    sa.Column('id', sa.INTEGER(), nullable=False),
    ...
    muscle_group_table = op.create_table('muscle_group',
    sa.Column('id', sa.INTEGER(), nullable=False),
